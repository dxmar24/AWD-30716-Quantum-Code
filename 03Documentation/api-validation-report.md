...
Generated: 2026-07-02T22:18:35.992Z
...
- Passed: 102
- Failed: 0
- Sample enrollment request id: 55abf4c5-ba42-4b48-94bd-9e9f4ce86ef5
- Sample attendance record id: 3820ab16-3290-4da9-8fab-3c9d3ca6b58f
...
| Admin updates a user role | `PATCH` | `/api/v1/users/52bf4ca6-6e50-45a2-9c9c-989f79d561fa/role` | 200 | 200 | Pass | User role updated |
...
| Admin reads branch by id | `GET` | `/api/v1/branches/355b2be5-6350-4f89-8e08-94d09a9c84ea` | 200 | 200 | Pass | OK |
| Admin updates branch | `PATCH` | `/api/v1/branches/355b2be5-6350-4f89-8e08-94d09a9c84ea` | 200 | 200 | Pass | branches updated |
...
| Admin reads student by id | `GET` | `/api/v1/students/8b1edd02-cf0b-4ae8-91eb-9bfd6488e363` | 200 | 200 | Pass | OK |
| Admin updates student | `PATCH` | `/api/v1/students/8b1edd02-cf0b-4ae8-91eb-9bfd6488e363` | 200 | 200 | Pass | students updated |
...
| Admin reads teacher by id | `GET` | `/api/v1/teachers/98cef528-454c-4425-be4b-564eac132ec9` | 200 | 200 | Pass | OK |
| Admin updates teacher | `PATCH` | `/api/v1/teachers/98cef528-454c-4425-be4b-564eac132ec9` | 200 | 200 | Pass | teachers updated |
...
| Admin reads dance category by id | `GET` | `/api/v1/dance-categories/dd990021-7c6d-433b-976b-0b65f8b836d0` | 200 | 200 | Pass | OK |
| Admin updates dance category | `PATCH` | `/api/v1/dance-categories/dd990021-7c6d-433b-976b-0b65f8b836d0` | 200 | 200 | Pass | dance-categories updated |
...
| Admin reads dance style by id | `GET` | `/api/v1/dance-styles/fd3c4ac6-eff5-499d-9b9a-f0b298e46411` | 200 | 200 | Pass | OK |
| Admin updates dance style | `PATCH` | `/api/v1/dance-styles/fd3c4ac6-eff5-499d-9b9a-f0b298e46411` | 200 | 200 | Pass | dance-styles updated |
...
| Admin reads class group by id | `GET` | `/api/v1/class-groups/62f95e95-cc12-4ff4-941c-881bfd299818` | 200 | 200 | Pass | OK |
| Admin updates class group | `PATCH` | `/api/v1/class-groups/62f95e95-cc12-4ff4-941c-881bfd299818` | 200 | 200 | Pass | class-groups updated |
...
| Admin reads class session by id | `GET` | `/api/v1/class-sessions/04594e5c-b5e3-4541-830d-bc1a7b0cf147` | 200 | 200 | Pass | OK |
| Admin updates class session | `PATCH` | `/api/v1/class-sessions/04594e5c-b5e3-4541-830d-bc1a7b0cf147` | 200 | 200 | Pass | class-sessions updated |
...
| Admin checks out teacher | `PATCH` | `/api/v1/teacher-attendance/9428206d-b4e0-4c0d-afe5-09f43057676b/check-out` | 200 | 200 | Pass | Teacher checked out |
| Duplicate teacher checkout is rejected | `PATCH` | `/api/v1/teacher-attendance/9428206d-b4e0-4c0d-afe5-09f43057676b/check-out` | 409 | 409 | Pass | Teacher attendance record already checked out |
...
| Admin reviews absence justification | `PATCH` | `/api/v1/absence-justifications/b9d108f5-85ef-4f53-a90e-b3747a0b0f58/review` | 200 | 200 | Pass | Absence justification reviewed |
| Admin gets branch summary report | `GET` | `/api/v1/reports/branches/summary` | 200 | 200 | Pass | OK |
| Admin gets scholarship candidate report | `GET` | `/api/v1/reports/scholarships/8b1edd02-cf0b-4ae8-91eb-9bfd6488e363/candidate` | 200 | 200 | Pass | OK |
| Admin gets level promotion candidate report | `GET` | `/api/v1/reports/level-promotions/8b1edd02-cf0b-4ae8-91eb-9bfd6488e363/candidate` | 200 | 200 | Pass | OK |
| Admin gets teacher payment report | `GET` | `/api/v1/reports/teachers/98cef528-454c-4425-be4b-564eac132ec9/payment` | 200 | 200 | Pass | OK |
