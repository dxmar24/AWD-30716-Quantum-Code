...
Generated: 2026-07-06T03:38:47.960Z
...
- Passed: 108
- Failed: 0
- Sample enrollment request id: 2c9fe326-aac5-40df-a7f3-5dc14309adff
- Sample attendance record id: 1992f962-31c5-4be0-8366-d3bd692fa1f6
...
| Admin updates a user role | `PATCH` | `/api/v1/users/a4ff9be4-8de6-40f8-a932-533666ce6a26/role` | 200 | 200 | Pass | User role updated |
...
| Admin reads branch by id | `GET` | `/api/v1/branches/c426f358-df66-44f6-889c-945aefefd7e0` | 200 | 200 | Pass | OK |
| Admin updates branch | `PATCH` | `/api/v1/branches/c426f358-df66-44f6-889c-945aefefd7e0` | 200 | 200 | Pass | branches updated |
| Google login creates session for BranchDirector | `POST` | `/api/v1/auth/google` | 200 | 200 | Pass | Login successful |
| Admin assigns branch access to BranchDirector | `PATCH` | `/api/v1/users/7efa7307-7ab9-48bd-9938-74713abafdc2/branch-access` | 200 | 200 | Pass | User branch access updated |
| Admin reads BranchDirector branch access | `GET` | `/api/v1/users/7efa7307-7ab9-48bd-9938-74713abafdc2/branch-access` | 200 | 200 | Pass | User branch access |
...
| Admin reads student by id | `GET` | `/api/v1/students/208e59de-e4ae-48f8-951b-d9a0c7f7e4a6` | 200 | 200 | Pass | OK |
| Admin updates student | `PATCH` | `/api/v1/students/208e59de-e4ae-48f8-951b-d9a0c7f7e4a6` | 200 | 200 | Pass | students updated |
...
| Admin reads teacher by id | `GET` | `/api/v1/teachers/30d28180-c47c-434f-a75c-902b4799274f` | 200 | 200 | Pass | OK |
| Admin updates teacher | `PATCH` | `/api/v1/teachers/30d28180-c47c-434f-a75c-902b4799274f` | 200 | 200 | Pass | teachers updated |
...
| Admin reads dance category by id | `GET` | `/api/v1/dance-categories/2ad5675e-c8d7-4417-9743-ab517011a363` | 200 | 200 | Pass | OK |
| Admin updates dance category | `PATCH` | `/api/v1/dance-categories/2ad5675e-c8d7-4417-9743-ab517011a363` | 200 | 200 | Pass | dance-categories updated |
...
| Admin reads dance style by id | `GET` | `/api/v1/dance-styles/cdc8e3ac-63c0-46ce-af47-76235eb4d740` | 200 | 200 | Pass | OK |
| Admin updates dance style | `PATCH` | `/api/v1/dance-styles/cdc8e3ac-63c0-46ce-af47-76235eb4d740` | 200 | 200 | Pass | dance-styles updated |
...
| Admin reads class group by id | `GET` | `/api/v1/class-groups/d2b842a7-bdf0-485c-9767-06c9c02e24c7` | 200 | 200 | Pass | OK |
| Admin updates class group | `PATCH` | `/api/v1/class-groups/d2b842a7-bdf0-485c-9767-06c9c02e24c7` | 200 | 200 | Pass | class-groups updated |
...
| Admin reads class session by id | `GET` | `/api/v1/class-sessions/8ccbc67c-0ea9-487e-9ea7-cd846819e66e` | 200 | 200 | Pass | OK |
| Admin updates class session | `PATCH` | `/api/v1/class-sessions/8ccbc67c-0ea9-487e-9ea7-cd846819e66e` | 200 | 200 | Pass | class-sessions updated |
...
| Admin checks out teacher | `PATCH` | `/api/v1/teacher-attendance/23e46a0f-9a4d-4fae-beb8-70e996ae6538/check-out` | 200 | 200 | Pass | Teacher checked out |
| Duplicate teacher checkout is rejected | `PATCH` | `/api/v1/teacher-attendance/23e46a0f-9a4d-4fae-beb8-70e996ae6538/check-out` | 409 | 409 | Pass | Teacher attendance record already checked out |
...
| Admin reviews absence justification | `PATCH` | `/api/v1/absence-justifications/7c356ba7-57dd-4225-9647-9d4b9440d978/review` | 200 | 200 | Pass | Absence justification reviewed |
| Admin gets branch summary report | `GET` | `/api/v1/reports/branches/summary` | 200 | 200 | Pass | OK |
| Admin gets scholarship candidate report | `GET` | `/api/v1/reports/scholarships/208e59de-e4ae-48f8-951b-d9a0c7f7e4a6/candidate` | 200 | 200 | Pass | OK |
| Admin gets level promotion candidate report | `GET` | `/api/v1/reports/level-promotions/208e59de-e4ae-48f8-951b-d9a0c7f7e4a6/candidate` | 200 | 200 | Pass | OK |
| Admin gets teacher payment report | `GET` | `/api/v1/reports/teachers/30d28180-c47c-434f-a75c-902b4799274f/payment` | 200 | 200 | Pass | OK |
