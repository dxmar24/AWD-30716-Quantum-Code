...
class PostgresUserRepository {
  ...
  async create(data) {
    ...
    const result = await this.pool.query(
      'INSERT INTO users (google_sub, email, name, password_hash, role_id, active) VALUES ($1, $2, $3, $4, $5, COALESCE($6, TRUE)) RETURNING id',
      [data.googleSub || null, data.email, data.name, data.passwordHash || null, roleId, data.active],
    );
