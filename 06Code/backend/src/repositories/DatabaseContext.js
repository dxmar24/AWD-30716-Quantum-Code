...
class DatabaseContext {
  constructor() {
    ...
    this.users = new InMemoryRepository([
      ...
      { id:'abababab-abab-4aba-8bab-abababababab', email:'student@alc.edu', name:'Demo Student User', role:Roles.STUDENT, googleSub:'test-student', active:true, mustChangePassword:false, passwordHash:hashPassword('StudentALC2026!') },
    ...
    this.branches = new InMemoryRepository([{ id:branchIds.norte, name:'Norte', city:'Quito', active:true },{ id:branchIds.matriz, name:'Matriz Sur', city:'Quito', active:true },{ name:'Quitumbe', city:'Quito', active:true },{ name:'Tumbaco', city:'Quito', active:true },{ name:'Conocoto', city:'Quito', active:true }]);
